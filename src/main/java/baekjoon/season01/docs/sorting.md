...
```java
package baekjoon.season01.problems.problem10814;
...
### 백준 1181 : 문자열의 길이를 기준으로 정렬 먼저하기 -> `Comparator.comparingInt(String::length)`

```java
package baekjoon.season01.problems.problem1181;
